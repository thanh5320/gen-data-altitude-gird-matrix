public class Constant {
  public static final double RADIUS_OF_EARTH = 6371000; // Đơn vị đo lường bán kính Trái đất (km), có thể được đổi sang đơn vị khác tùy thuộc vào mục đích sử dụng
  public static final double AZIMUTH = 90; // Phương kinh độ, tính theo độ
  public static final double BEARING = 0; // Phương vĩ độ, tính theo độ
